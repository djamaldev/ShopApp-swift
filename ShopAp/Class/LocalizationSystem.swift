...
class LocalizationSystem:NSObject {
    ...
    var bundle: Bundle!
    static let lang = LocalizationSystem().getAppLanguage()
    ...
    func getAppLanguage() -> NSDictionary? {
        return UserDefaults.standard.value(forKey: "AppleLanguages") as? NSDictionary
      //  return UserDefaults.standard.object(forKey: "AppleLanguages") as? NSDictionary
    }
