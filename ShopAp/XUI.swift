...
class XButton : UIButton {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        FirstColor = UIColor(red: 54.0/255.0, green: 209.0/255.0, blue: 220.0/255.0, alpha: 1.0)
        SecondColor = UIColor(red: 91.0/255.0, green: 134.0/255.0, blue: 229.0/255.0, alpha: 1.0)
        self.tintColor = UIColor.white
        self.setTitleColor(UIColor.white, for: .normal )
    }
    /*public func config(title:String){
        self.setTitle(LocalizationSystem.sharedInstance.localizedStringForKey(key: title, comment: ""), for: .normal)
    }*/
    ...
    func Loading() {
        ...
        //self.setImage(loading, for: .normal)
        self.setImage(UIImage(named: "loading"), for: .normal)
        LoadingAnimations()
    }
...
@IBDesignable class XTextField : UITextField {
    ...
    /*@objc public func config(placeHolder:String){
        self.placeholder = LocalizationSystem.sharedInstance.localizedStringForKey(key: placeHolder, comment: "")
    }*/
...
extension UILabel {
    public func config(text:String){
        self.text = LocalizationSystem.sharedInstance.localizedStringForKey(key: text, comment: "")
        self.font = UIFont(name: APP_FONT_REGULAR, size: 30)
    }
    //UIFont.init(name:APP_FONT_REGULAR, size: size)
}
...
extension UIButton {
    public func config(title:String){
        self.setTitle(LocalizationSystem.sharedInstance.localizedStringForKey(key: title, comment: ""), for: .normal)
        self.titleLabel?.font = UIFont(name: APP_FONT_REGULAR, size: 20)
...
extension UITextField{
    public func config(placeHolder:String){
        self.placeholder = LocalizationSystem.sharedInstance.localizedStringForKey(key: placeHolder, comment: "")
        self.font = UIFont(name: APP_FONT_REGULAR, size: 30)
    }
}
...
extension UIBarButtonItem{
    public func config(title:String){
        self.title = LocalizationSystem.sharedInstance.localizedStringForKey(key: title, comment: "")
        //self.setTitleTextAttributes([NSAttributedString.Key.font : UIFont(name: APP_FONT_REGULAR, size: 30)!], for: .normal)
    }
}

extension UINavigationBar{
    public func config(title:String){
        self.topItem?.title = LocalizationSystem.sharedInstance.localizedStringForKey(key: title, comment: "")
    }
}
